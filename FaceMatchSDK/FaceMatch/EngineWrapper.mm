...
+(void) FaceEngineInit
{
    ...
    NSBundle* myBundle = [NSBundle bundleWithIdentifier:@"com.demo.FaceMatchSDK"];

    NSString* dataFilePath1 = [myBundle pathForResource:@"model1" ofType:@"dat"];

    NSString* dataFilePath2 = [myBundle pathForResource:@"model2" ofType:@"dat"];
